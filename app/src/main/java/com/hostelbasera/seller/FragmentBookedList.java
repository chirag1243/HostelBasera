...
import com.hostelbasera.main.AdapterOrderList;
...
public class FragmentBookedList extends Fragment {
    ...
    public static FragmentBookedList newInstance() {
    ...
    public void getOrderListData() {
        JSONObject postData = HttpRequestHandler.getInstance().getSellerOrderDataParam();

        if (postData != null) {
            new PostRequest(getActivity(), getString(R.string.getSellerOrderData),
